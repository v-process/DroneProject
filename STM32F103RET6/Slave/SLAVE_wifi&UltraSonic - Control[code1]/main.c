...
void Initailze_value()
{
  ...
  Drone_Control.axis[PITCH].TargetAngle = 0;
  Drone_Control.axis[ROLL].TargetAngle = 0;
 ...
 // Tx_String(USART1, "START\n");
  ...
  while(1) {     
     ...
     //   Tx_Data(USART1, '-');
      ...
      else if((Send_Count%5) == 1)   Tx_Data16t(USART3, Drone_Control.axis[ROLL].TargetAngle);
      else if((Send_Count%5) == 2)   Tx_Data16t(USART3, Drone_Control.axis[PITCH].TargetAngle);
      //else if((Send_Count%6) == 2)   Tx_Data16t(USART3, Drone_Control.axis[PITCH].KP);
      //else if((Send_Count%6) == 3)   Tx_Data16t(USART3, Drone_Control.axis[PITCH].KI);
      //else if((Send_Count%6) == 4)   Tx_Data16t(USART3, Drone_Control.axis[PITCH].KD);
      //else if((Send_Count%6) == 5)   Tx_Data16t(USART3, Drone_Control.Height1);
