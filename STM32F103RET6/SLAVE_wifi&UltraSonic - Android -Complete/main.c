...
int main()
{
  ...
  while(1) {     
      ...
      else if((Send_Count%6) == 1)   Tx_Data16t(USART3, Drone_Control.axis[ROLL].TargetAngle);
      else if((Send_Count%6) == 2)   Tx_Data16t(USART3, Drone_Control.axis[PITCH].TargetAngle);
      ...
      else if((Send_Count%6) == 3)   Tx_Data16t(USART3, Drone_Control.Height1);
